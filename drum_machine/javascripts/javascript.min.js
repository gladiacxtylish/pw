...
offset:[2,2],opacity:0.5}});a.add(d);this.buttons.getButton(b,c).set("graphic",d)}},nextInterval:function(){this.indicators.at(0<=this.currentColumn-1?this.currentColumn-1:this.column-1).get("graphic").setFill("#CDB380");this.indicators.at(this.currentColumn).get("graphic").setFill("#033649");this.graphicsLayer.draw();for(var a=0;a<this.row;a++)this.buttons.getButton(a,this.currentColumn).get("enabled")&&soundManager.play(e[a],{multiShotEvents:!0});this.currentColumn++;this.currentColumn>=this.column&&
